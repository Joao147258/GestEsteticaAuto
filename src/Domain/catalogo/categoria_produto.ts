...
import {
  ...
  CriarCategoriaProdutoProps,
} from "./CategoriaProdutoProps";

// Categoria que agrupa produtos (apenas organização do catálogo).
export class CategoriaProduto {
  private constructor(private readonly props: CategoriaProdutoProps) {}
  ...
  static criar(props: CriarCategoriaProdutoProps): CategoriaProduto {
    ...
    if (!nome) {
      throw new CatalogoError("Nome da categoria de produto é obrigatório");
    }
